...
app.post("/submit", (req, res) => {
  ...
  let n = Math.floor(Math.random() * adj.length + 1);
  let randomAdj = adj[n];

  let x = Math.floor(Math.random() * noun.length + 1);
  let randomNoun = noun[x];

  res.render("index.ejs", { fName: randomAdj, lName: randomNoun });
